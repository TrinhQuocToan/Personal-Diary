...
const UserProfile = () => {
  const { currentColor, setIsLoggedIn, setIsClicked, initialState } = useStateContext();
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end items-start pt-16">
      ...
      <div
        ...
        onClick={() => setIsClicked({ ...initialState, userProfile: false })}
      />
      <div className="relative right-4 w-96 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden backdrop-blur-md bg-opacity-98">
